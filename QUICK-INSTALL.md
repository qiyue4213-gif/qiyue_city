...
```bash
# Python 依赖
pip install playwright faster-whisper requests beautifulsoup4 lxml -q
...
**执行脚本**：
```bash
python3 article_extractor.py "<文章链接>" -o output.md -f
```
...
| `QUICK-INSTALL.md` | 快速安装说明 | `~/.agents/skills/content-processor/` |
| `scripts/article_extractor.py` | 文章链接抓取 | `~/.agents/skills/content-processor/scripts/` |
